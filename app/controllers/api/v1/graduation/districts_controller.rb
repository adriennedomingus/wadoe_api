class Api::V1::Graduation::DistrictsController < Api::ApiController
  ...
  def highest
    ...
    if !school_year
      ...
      district_school_years = DistrictSchoolYear.highest_cohort_graduation_rate(school_year, number, identifier)
      respond_with district_school_years, each_serializer: DistrictSchoolYearGraduationSerializer, scope: identifier_name
    else
